...
import { FolderTree, PackageOpen, Tags } from "lucide-react";
...
export default async function AdminPage() {
  ...
  const cards = [
    { href: "/admin/packs", title: "Paketler", body: "Taslakları düzenle, yayın durumunu ve öne çıkarma alanlarını yönet.", icon: PackageOpen },
    { href: "/admin/categories", title: "Kategoriler", body: "Public paket taksonomisini, görünürlüğü ve sıralamayı yönet.", icon: FolderTree },
    { href: "/admin/tags", title: "Etiketler", body: "Paketlerde kullanılan aranabilir etiketleri yönet.", icon: Tags },
  ] as const;
  return (
