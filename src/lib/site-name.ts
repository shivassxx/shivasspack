...
import { readSiteDescription, readSiteName } from "@/services/admin/settings";
...
export const getSiteDescription = cache(async () => {
  await connection();
  return readSiteDescription(getDatabase().db);
});
